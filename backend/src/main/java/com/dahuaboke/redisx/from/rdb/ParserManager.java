...
import com.dahuaboke.redisx.from.rdb.hash.*;
...
public class ParserManager {
    ...
    public static final Parser<Stream> HASH_METADATA_PRE_GA_16 = new HashExPreGaParser();

    public static final Parser<Stream> HASH_LISTPACK_EX_PRE_GA_17 = new HashListPackExPreGaParser();

    public static final Parser<Stream> HASH_METADATA_18 = new HashExParser();

    public static final Parser<Stream> HASH_LISTPACK_EX_19 = new HashListPackExParser();
    ...
    static {
        ...
        ParserManager.parserMap.put(0x16 & 0xff, HASH_METADATA_PRE_GA_16);
        ParserManager.parserMap.put(0x17 & 0xff, HASH_LISTPACK_EX_PRE_GA_17);
        ParserManager.parserMap.put(0x18 & 0xff, HASH_METADATA_18);
        ParserManager.parserMap.put(0x19 & 0xff, HASH_LISTPACK_EX_19);
    }
