...
public class Demo02CategoryController {
    ...
    @PostMapping("/create")
    @Operation(tags = "示例管理",summary = "创建示例分类")
    ...
    @PutMapping("/update")
    @Operation(tags = "示例管理",summary = "更新示例分类")
    ...
    @Operation(tags = "示例管理",summary = "删除示例分类")
    ...
    @GetMapping("/get")
    @Operation(tags = "示例管理",summary = "获得示例分类")
    ...
    @GetMapping("/list")
    @Operation(tags = "示例管理",summary = "获得示例分类列表")
    @PreAuthorize("@ss.hasPermission('infra:demo02-category:query')")
    ...
    @Operation(tags = "示例管理",summary = "导出示例分类 Excel")
