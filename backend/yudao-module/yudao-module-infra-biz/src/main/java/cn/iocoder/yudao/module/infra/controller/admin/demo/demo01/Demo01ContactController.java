...
public class Demo01ContactController {
    ...
    @PostMapping("/create")
    @Operation(tags = "示例管理",summary = "创建示例联系人")
    ...
    @PutMapping("/update")
    @Operation(tags = "示例管理",summary = "更新示例联系人")
    ...
    @Operation(tags = "示例管理",summary = "删除示例联系人")
    ...
    @GetMapping("/get")
    @Operation(tags = "示例管理",summary = "获得示例联系人")
    ...
    @GetMapping("/page")
    @Operation(tags = "示例管理",summary = "获得示例联系人分页")
    @PreAuthorize("@ss.hasPermission('infra:demo01-contact:query')")
    ...
    @Operation(tags = "示例管理",summary = "导出示例联系人 Excel")
