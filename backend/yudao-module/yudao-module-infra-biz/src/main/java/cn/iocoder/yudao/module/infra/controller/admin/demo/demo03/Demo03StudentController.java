...
public class Demo03StudentController {
    ...
    @PostMapping("/create")
    @Operation(tags = "示例管理",summary = "创建学生")
    ...
    @PutMapping("/update")
    @Operation(tags = "示例管理",summary = "更新学生")
    ...
    @Operation(tags = "示例管理",summary = "删除学生")
    ...
    @GetMapping("/get")
    @Operation(tags = "示例管理",summary = "获得学生")
    ...
    @GetMapping("/page")
    @Operation(tags = "示例管理",summary = "获得学生分页")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:query')")
    ...
    @Operation(tags = "示例管理",summary = "导出学生 Excel")
    ...
    @Operation(tags = "示例管理",summary = "获得学生课程分页")
    ...
    @Operation(tags = "示例管理",summary = "创建学生课程")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:create')")
    ...
    @Operation(tags = "示例管理",summary = "更新学生课程")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:update')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @Operation(tags = "示例管理",summary = "删除学生课程")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:delete')")
    ...
    @Operation(tags = "示例管理",summary = "获得学生课程")
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:query')")
    ...
    @Operation(tags = "示例管理",summary = "获得学生课程列表")
    @Parameter(name = "studentId", description = "学生编号")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:query')")
    ...
    @Operation(tags = "示例管理",summary = "获得学生班级分页")
    @Parameter(name = "studentId", description = "学生编号")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:query')")
    ...
    @Operation(tags = "示例管理",summary = "创建学生班级")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:create')")
    ...
    @Operation(tags = "示例管理",summary = "更新学生班级")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:update')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @Operation(tags = "示例管理",summary = "删除学生班级")
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:delete')")
    ...
    @Operation(tags = "示例管理",summary = "获得学生班级")
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('infra:demo03-student:query')")
