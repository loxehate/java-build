 ...
 * 表单设计器相关
 */
public interface IDesFormService extends IService<DesformEntity> {

    //保存
    Long saveDesForm(DesFormAddOrUpdateParam param);

    //修改
    void updateDesForm(DesFormAddOrUpdateParam param);
