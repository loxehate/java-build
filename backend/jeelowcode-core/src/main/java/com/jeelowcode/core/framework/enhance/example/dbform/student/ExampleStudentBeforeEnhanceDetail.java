 ...
 */
@Slf4j
@Component("studentBeforeEnhanceDetail")
public class ExampleStudentBeforeEnhanceDetail implements BeforeAdvicePlugin {

    @Override
    public void execute(EnhanceContext enhanceContext) {
        log.info("进入=======>studentBeforeEnhanceDetail=======>execute");
