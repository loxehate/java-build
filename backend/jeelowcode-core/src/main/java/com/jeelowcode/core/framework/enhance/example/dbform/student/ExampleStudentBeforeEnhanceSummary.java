 ...
 */
@Slf4j
@Component("studentBeforeEnhanceSummary")
public class ExampleStudentBeforeEnhanceSummary implements BeforeAdvicePlugin {

    @Override
    public void execute(EnhanceContext enhanceContext) {
        log.info("进入=======>studentBeforeEnhanceSummary=======>execute");
