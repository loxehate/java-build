 ...
 */
@Slf4j
@Component(value="studentBeforeEnhancePage")
public class ExampleStudentBeforeEnhancePage implements BeforeAdvicePlugin {

    @Override
    public void execute(EnhanceContext enhanceContext) {
        log.info("进入=======>studentBeforeEnhancePage=======>execute");
