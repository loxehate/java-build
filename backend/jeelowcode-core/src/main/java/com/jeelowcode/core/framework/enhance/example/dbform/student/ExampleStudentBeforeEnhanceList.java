 ...
 */
@Slf4j
@Component("studentBeforeEnhanceList")
public class ExampleStudentBeforeEnhanceList implements BeforeAdvicePlugin {

    @Override
    public void execute(EnhanceContext enhanceContext) {
        log.info("进入=======>studentBeforeEnhanceList=======>execute");
