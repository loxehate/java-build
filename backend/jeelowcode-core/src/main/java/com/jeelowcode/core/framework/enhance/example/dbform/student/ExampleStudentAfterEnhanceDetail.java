 ...
 */
@Slf4j
@Component("studentAfterEnhanceDetail")
public class ExampleStudentAfterEnhanceDetail implements AfterAdvicePlugin {

    @Override
    public void execute(EnhanceContext enhanceContext) {
        log.info("进入=======>studentAfterEnhanceDetail=======>execute");
