 ...
 * 系统首页-使用统计-使用最少模块
 */
@Component("exampleSytjSyzsmkReportEnhance")
public class ExampleSytjSyzsmkReportEnhance implements ReportAfterAdvicePlugin {
    ...
    public void execute(EnhanceReportContext enhanceContext) {
        ...
        List<Map<String, Object>> list = exampleReportMapper.getMinUsedModel(begin, end);
