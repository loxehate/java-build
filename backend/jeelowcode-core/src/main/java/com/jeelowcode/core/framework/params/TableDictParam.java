...
@Data
public class TableDictParam {
    @Schema(description = "类型code(user,dept)")
    private List<String> typeCodeList;

    @Schema(description = "用户 参数")
    private JeeLowCodeUserParam userParam;

    @Schema(description = "部门 参数")
    private JeeLowCodeDeptParam deptParam;
